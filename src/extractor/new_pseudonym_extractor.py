...
def extract_new_pseudonym_line(lines):
    ...
    with open(os.path.join(settings.AOZORA_DATA_DIR_PATH, 'list_new_pseudonym.csv'), 'w') as list_new_pseudonym:
...
if __name__ == '__main__':
    list_person_all_extended_utf8_path = os.path.join(settings.AOZORA_DATA_DIR_PATH, 'list_person_all_extended_utf8.csv')
